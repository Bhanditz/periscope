...
class Ren(Network):
    ...
    def init_constants(self):
        super(Ren, self).init_constants()
        self.crop_size = (113, 113)
    ...
    def regularize_parameters(self):
        ...
        # l1 = lasagne.regularization.regularize_layer_params_weighted(
        #         self.layer_map(l1map), lasagne.regularization.l1) * 1e-2
        return l2
