...
from periscope.nonlinearities import rectsquish7
...
def apply_squish_bn(layer):
    ...
    return NonlinearityLayer(network, rectsquish7)
...
def apply_relu_bn(layer):
    if hasattr(layer, 'b') and layer.b is not None:
        ...
        layer.b = None
    network = QuickNormLayer(layer)
    return NonlinearityLayer(network, rectify)
...
# 1895940 params
class Sresq7(Network):

    def init_constants(self):
        super(Sresq7, self).init_constants()
