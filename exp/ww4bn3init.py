...
# Initialize batchnorm biases with -0.25, -0.5, -0.75, -1.
# and add 8x speed update for batchnorm biases.
# Fixed application of batchnorm. 23669156 params.
class Ww4bn3init(Network):

    def init_constants(self):
        super(Ww4bn3init, self).init_constants()
