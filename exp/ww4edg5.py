...
from periscope.layers import EdgeDecayLayer, LandmarkLayer
import lasagne
...
# Edge-Decay version of ww4bn2, 23669156 params.
class Ww4edg5(Network):

    def init_constants(self):
        super(Ww4edg5, self).init_constants()
    ...
    def hidden_layers(self, network, **kwargs):
        # 1st. Data size 96->96
        network = EdgeDecayLayer(network)
