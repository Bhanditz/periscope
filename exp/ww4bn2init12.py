...
# Fixed application of batchnorm. 23669126 params.
class Ww4bn2init12(Network):

    def init_constants(self):
        super(Ww4bn2init12, self).init_constants()
    ...
    def hidden_layers(self, network, **kwargs):
        ...
        network = batch_norm(network, beta=Constant(-1.2), gamma=None)
