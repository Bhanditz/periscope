...
from lasagne.layers import FeatureWTALayer, ParametricRectifierLayer
...
class Swss(Network):
    ...
    def init_constants(self):
        super(Swss, self).init_constants()
    ...
    def hidden_layers(self, network, **kwargs):
        ...
        # 128 + 256 = 384 ch
        network = swa_gadget(network, 128, stride=2, pad=1, name="goo7")
