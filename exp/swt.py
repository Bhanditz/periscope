...
from lasagne.layers import ParametricRectifierLayer, FeatureWTALayer
...
class Swt(Network):
    ...
    def hidden_layers(self, network, **kwargs):
        ...
        # 96 + 128 = 224 ch
        network = swa_gadget(network, 128, stride=2, wta=4, name="goo4")
        ...
        # 128 + 256 = 384 ch
        network = swa_gadget(network, 128, name="goo7")
  
        # 7th. Data size 3 -> 1, 592 + 512 ch
        # 1*1*896 = 896, rf:113x113
        # 384 + 512 = 896 ch
        network = swa_gadget(network, 512, wta=4, name="goo8")
